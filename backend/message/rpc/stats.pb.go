...
type StatsResponse struct {
	...
	NumMsgs              int64                `protobuf:"varint,2,opt,name=numMsgs,proto3" json:"numMsgs,omitempty"`
	LastBump             *timestamp.Timestamp `protobuf:"bytes,3,opt,name=lastBump,proto3" json:"lastBump,omitempty"`
...
func (m *StatsResponse) GetNumMsgs() int64 {
	if m != nil {
		return m.NumMsgs
	}
	return 0
...
func (m *StatsResponse) GetLastBump() *timestamp.Timestamp {
	if m != nil {
		return m.LastBump
	}
	return nil
...
var fileDescriptor_b4756a0aec8b9d44 = []byte{
	...
	0xa3, 0x06, 0x73, 0x10, 0x8c, 0x2b, 0x64, 0xc6, 0xc5, 0x91, 0x93, 0x58, 0x5c, 0xe2, 0x54, 0x9a,
	...
	0x9d, 0x62, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x3a, 0x78, 0x9e, 0xd6, 0x20, 0x01, 0x00, 0x00,
}
